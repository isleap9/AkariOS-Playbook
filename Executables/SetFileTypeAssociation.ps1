...
Set-FTA '7-Zip.rar' '.rar'
Set-FTA '7-Zip.001' '.001'
Set-FTA '7-Zip.cab' '.cab'
Set-FTA '7-Zip.iso' '.iso'
Set-FTA '7-Zip.xz' '.xz'
Set-FTA '7-Zip.txz' '.txz'
Set-FTA '7-Zip.lzma' '.lzma'
Set-FTA '7-Zip.tar' '.tar'
Set-FTA '7-Zip.cpio' '.cpio'
Set-FTA '7-Zip.bz2' '.bz2'
Set-FTA '7-Zip.bzip2' '.bzip2'
Set-FTA '7-Zip.tbz2' '.tbz2'
Set-FTA '7-Zip.tbz' '.tbz'
Set-FTA '7-Zip.gz' '.gz'
Set-FTA '7-Zip.gzip' '.gzip'
Set-FTA '7-Zip.tgz' '.tgz'
Set-FTA '7-Zip.tpz' '.tpz'
Set-FTA '7-Zip.z' '.z'
Set-FTA '7-Zip.taz' '.taz'
Set-FTA '7-Zip.lzh' '.lzh'
Set-FTA '7-Zip.lha' '.lha'
Set-FTA '7-Zip.rpm' '.rpm'
Set-FTA '7-Zip.deb' '.deb'
Set-FTA '7-Zip.arj' '.arj'
Set-FTA '7-Zip.vhd' '.vhd'
Set-FTA '7-Zip.wim' '.wim'
Set-FTA '7-Zip.swm' '.swm'
Set-FTA '7-Zip.esd' '.esd'
Set-FTA '7-Zip.fat' '.fat'
Set-FTA '7-Zip.ntfs' '.ntfs'
Set-FTA '7-Zip.dmg' '.dmg'
Set-FTA '7-Zip.hfs' '.hfs'
Set-FTA '7-Zip.xar' '.xar'
Set-FTA '7-Zip.squashfs' '.squashfs'
Set-FTA '7-Zip.apfs' '.apfs'